...
const BIZ = {
  ...
  hoursWeekend:'Sabtu – Ahad  |  9:00 PG – 10:00 MLM',
...
const T = {
  ...
  bm: {
    ...
    menu: [
      ...
      { name:'Laksa Tauhu',           desc:'Kuah laksa kelapa berkrim dengan tauhu sutera, mi beras, tauhu puff rangup, dan sambal.',                               price:'RM 13.90', badge:'Signature',       badgeColor:'bg-cyan-100 text-cyan-700',    emoji:'🍜' },
      { name:'Tau Fu Fah',            desc:'Pudding tauhu sutera tradisional dihidangkan panas atau sejuk dengan sirap halia. Pencuci mulut yang sempurna.',        price:'RM 5.90',  badge:'Pencuci Mulut',   badgeColor:'bg-purple-100 text-purple-700',emoji:'🍮' },
    ],
    about: {
      label:   'Kisah Kami',
    ...
    contact: {
      ...
      weekend:  'Sabtu – Ahad  |  9:00 PG – 10:00 MLM',
    },
